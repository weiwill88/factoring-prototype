...
const mockData = [
    { id: "dom-1", businessNumber: "DOM-2025-001", supplierName: "上海明远科技有限公司", buyerName: "中兵科技集团有限公司", productName: "国内保理-有追", totalAmount: 1600000, status: "已放款", applyDate: "2025-10-01", dueDate: "2026-01-01" },
  ];
...
export default function Page() {
  ...
  return (
    <div>
      <Title level={4} style={{ marginBottom: 16 }}>{'国内保理-补'}</Title>
      <Card>
